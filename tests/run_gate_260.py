...
GATE = [
    ...
    "smoke_hours_edit_295.py",    # #295 guard — sign-in correction history, issued-day amend flag + audit + auto re-render (content-verified), memo invalidation on the edit doors, honest Cancel copy
